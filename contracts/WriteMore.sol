...
import "./WriteMoreHelper.sol";
import {FunctionsClient} from "@chainlink/contracts/src/v0.8/functions/v1_0_0/FunctionsClient.sol";
import {ConfirmedOwner} from "@chainlink/contracts/src/v0.8/shared/access/ConfirmedOwner.sol";
import {FunctionsRequest} from "@chainlink/contracts/src/v0.8/functions/v1_0_0/libraries/FunctionsRequest.sol";

contract WriteMore is WriteMoreNFT, WriteMoreStorage, WriteMoreEvents, FunctionsClient, WriteMoreHelper {
    ...
    function returnCommitment() public {
        ...
        // purchase link token from user's balance
        uint256 senderBalance = committedUsers[msg.sender].atStakeAmount;
        // swap eth for link token
        swapEthForLink(senderBalance);
